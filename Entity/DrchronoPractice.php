...
/**
 * Class DrchronoPractice
 * @package AppBundle\Entity
 *
 * @ORM\Entity(repositoryClass="AppBundle\Repository\DrchronoPracticeRepository")
 * @ORM\Table(name="drchrono_practice")
 */
class DrchronoPractice
{
    /**
     ...
     * @Assert\Blank(
     *     groups={"drchrono_practice_post", "drchrono_practice_put"}
     * )
     */
    private $id;
